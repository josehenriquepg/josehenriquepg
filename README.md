...
I'm a full-stack developer dedicated to built projects from the ground up, from planning and designing all the way to solving real-life problems with code. Currently, i focus on **Java** and **Spring**.
...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,java,go,ts,nodejs,postgres,mysql,git&theme=dark)](https://skillicons.dev)
